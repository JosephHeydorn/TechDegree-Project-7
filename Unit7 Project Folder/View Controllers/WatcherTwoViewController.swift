//
//  WatcherTwoViewController.swift
...
var appendArrayTwo = [Int]()

class WatcherTwoViewController: UIViewController, UITextFieldDelegate {
    ...
    private var selectedName: NameData?
     ...
     override func viewDidLoad() {
            ...
            appendArrayTwo.removeAll()
            arrayOfURLSTwo.removeAll()
        ...
        private func gatherID() {
            appendArrayTwo.append(watcherTwoIDOne)
            appendArrayTwo.append(watcherTwoIDTwo)
            appendArrayTwo.append(watcherTwoIDThree)
            appendArrayTwo.append(watcherTwoIDFour)
            appendArrayTwo.append(watcherTwoIDFive)
        }
    ...
    extension WatcherTwoViewController: UIPickerViewDataSource {
    ...
    extension WatcherTwoViewController: UIPickerViewDelegate {
